...
plot_pdf_fpath = os.path.join(output_dir, "IQTREE_accuracy_vs_accuracy_python_by_transformation.pdf")
r_sq_boxplot_pdf_fpath = os.path.join(output_dir, "IQTREE_rsq_accuracy_v_accuracy_py_by_transf.pdf")
train_percent = 0.75
# --------------------------------------------------------------------------
...
comp_ds = ['Shuffle1_PhILR_Filtered_IQtree_blw.sqrt_enorm',\
...
num_cols = 1
ax_count = 1
ds1 = "Filtered_IQtree_blw.sqrt_enorm"
